...
import type { ExternalBlob as _ExternalBlob, FanEdit as _FanEdit, FanEditId as _FanEditId, Status as _Status, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async approveFanEdit(arg0: FanEditId): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.approveFanEdit(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteFanEdit(arg0: FanEditId): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteFanEdit(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getApprovedFanEdits(): Promise<Array<FanEdit>> {
        if (this.processError) {
            try {
                const result = await this.actor.getApprovedFanEdits();
    ...
    async getPendingFanEdits(): Promise<Array<FanEdit>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPendingFanEdits();
                return from_candid_vec_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async rejectFanEdit(arg0: FanEditId): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.rejectFanEdit(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitFanEdit(arg0: string, arg1: string, arg2: ExternalBlob): Promise<FanEditId> {
        if (this.processError) {
            try {
                const result = await this.actor.submitFanEdit(arg0, arg1, await to_candid_ExternalBlob_n18(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateFanEditStatus(arg0: FanEditId, arg1: Status): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateFanEditStatus(arg0, to_candid_Status_n19(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_FanEdit_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _FanEdit): Promise<FanEdit> {
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        videoId: await from_candid_ExternalBlob_n15(_uploadFile, _downloadFile, value.videoId)
    };
}
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_FanEdit>): Promise<Array<FanEdit>> {
    return await Promise.all(value.map(async (x)=>await from_candid_FanEdit_n11(_uploadFile, _downloadFile, x)));
}
